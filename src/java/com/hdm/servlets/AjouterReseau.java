 ...
 * @author MED
 */
public class AjouterReseau extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AjouterReseau</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AjouterReseau at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        this.getServletContext().getRequestDispatcher("/WEB-INF/ajouterReseau.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Reseau reseau = new Reseau(
                ...
                request.getParameter("masque"),
                request.getParameter("description"),
                request.getParameter("commentaire"),
                new Departement(Integer.parseInt(request.getParameter("departement"))));
        boolean isAdded = false;
        isAdded = reseauDao.ajouter(reseau);
