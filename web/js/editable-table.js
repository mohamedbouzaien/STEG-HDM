    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[6].innerHTML = '<select id="sites" class="form-control small"></select>';
                jqTds[8].innerHTML = '<select id="dept" class="form-control small"></select>';
                jqTds[10].innerHTML = '<a class="edit" href="">Enregistrer</a>';
                jqTds[11].innerHTML = '<a class="cancel" href="">Annuler</a>';
                $.ajax({
